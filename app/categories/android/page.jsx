    ...
    <>
      ...
      <main className=" text-dark  py-28 bg-cover w-full">
        ...
        <div className="flex flex-col gap-4 justify-center items-center">
          ...
          <p className="text-center font-medium md:text-xl text-sm px-5 md:w-[50%] ">
            ...
            mempersiapkan developer Android standar Global. lopercourse adalah
      ...
      <main className="mt-32 px-3 md:px-20 w-full">
            ...
            <div className="gap-2 md:gap-3 flex flex-col">
              ...
              <div className="flex gap-9">
                <div className="flex gap-3">
                  ...
                  <p className="font-semibold text-xs">50 jam</p>
                </div>
                <div className="flex gap-3">
                  <svg
                    width={16}
                  ...
                  <p className="font-semibold text-xs">4,84</p>
                </div>
                <div className="flex gap-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="flex gap-4">
                <div className="flex gap-3">
                  ...
                  <p className="font-normal text-xs">118,modul</p>
                </div>
                <div className="flex gap-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <p className="font-normal text-xs">47.332 Siswa terdaftar</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <span className="flex text-center  md:mt-0 mt-10 flex-col gap-4">
            ...
            <div className="flex justify-center">
              <p className="font-medium text-center md:w-[60%]">
                Langkah pertama untuk menjadi seorang Android Developer dengan
                mempelajari bahasa yang direkomendasikan oleh Google.
              </p>
            </div>
          </span>
        </div>
        <div className="flex-col md:flex mt-8 justify-between w-full items-center">
            ...
            <div className="gap-2 md:gap-3 flex flex-col">
              ...
              <div className="flex gap-9">
                <div className="flex gap-3">
                  ...
                  <p className="font-semibold text-xs">60 jam</p>
                </div>
                <div className="flex gap-3">
                  <svg
                    width={16}
              ...
              <div className="flex gap-4">
                <div className="flex gap-3">
                  ...
                  <p className="font-normal text-xs">49,modul</p>
                </div>
                <div className="flex gap-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <p className="font-normal text-xs">182.203 Siswa terdaftar</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <span className="flex text-center md:mt-0 mt-10 flex-col gap-4">
            <h1 className="font-bold text-xl">Membuat Aplikasi Sendiri</h1>
            <div className="flex justify-center">
              <p className="font-medium md:w-[80%]">
                Buat aplikasi pertamamu dengan memahami dasar-dasar membuat
        ...
        <div className="flex-col md:flex mt-8 justify-between w-full items-center">
          <div className=" px-6 md:w-[370px] sm:h-[164px] flex items-center hover:shadow-lg mx-auto h-[156px] border rounded-md border-gray-600 ">
            <div className="gap-2 md:gap-4 flex flex-col">
              ...
              <div className="flex gap-4">
                <div className="flex gap-3">
                  ...
                  <p className="font-normal text-xs">107,modul</p>
                </div>
                <div className="flex gap-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <p className="font-normal text-xs">38.222 Siswa terdaftar</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <span className="flex text-center  md:mt-0 mt-10 flex-col gap-4">
            ...
            <div className="flex justify-center">
              <p className="font-medium md:w-[50%]">
                Perdalam keahlianmu di dunia pemrograman Android dengan
                mempelajari cara membuat aplikasi yang dapat mengambil data dari
                server dan menyimpannya ke dalam database.
              </p>
            </div>
          </span>
        </div>
            ...
            <div className="gap-3 flex flex-col">
              ...
              <div className="flex gap-9">
                <div className="flex gap-3">
                  ...
                  <p className="font-semibold text-xs">150 jam</p>
                </div>
                <div className="flex gap-3">
                  <svg
                    width={16}
              ...
              <div className="flex gap-4">
                ...
                <div className="flex gap-3">
                  ...
                  <p className="font-normal text-xs">2.983 Siswa terdaftar</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <span className="flex text-center md:mt-0 mt-10 flex-col gap-4">
            ...
            <div className="flex justify-center">
              <p className="font-medium md:w-[70%]">
                Perdalam keahlian untuk menjadi Associate Android Developer yang
        ...
        <div className="flex-col md:flex mt-8 justify-between w-full items-center">
            ...
            <div className="gap-2 md:gap-4 flex flex-col">
              ...
              <div className="flex gap-9">
                <div className="flex gap-3">
                  ...
                  <p className="font-semibold text-xs">15 jam</p>
                </div>
                <div className="flex gap-3">
                  <svg
                    width={16}
              ...
              <div className="flex gap-4">
                ...
                <div className="flex gap-3">
                  ...
                  <p className="font-normal text-xs">12.931 Siswa terdaftar</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <span className="flex text-center  md:mt-0 mt-10 flex-col gap-4 ">
            ...
            <div className="flex justify-center">
              <p className="font-medium md:w-[70%]">
                Memperkaya modal menjadi Android Developer dengan belajar
                prinsip dasar SOLID.
              </p>
            </div>
          </span>
        ...
        <div className="flex-col md:flex mt-8  w-full items-center">
            ...
            <div className="gap-4 flex flex-col">
              ...
              <div className="flex gap-9">
                <div className="flex gap-3">
                  ...
                  <p className="font-semibold text-xs">90 jam</p>
                </div>
                <div className="flex gap-3">
                  <svg
                    width={16}
                  ...
                  <p className="font-semibold text-xs">4,82</p>
                </div>
                <div className="flex gap-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="flex gap-4">
                <div className="flex gap-3">
                  ...
                  <p className="font-normal text-xs">87,modul</p>
                </div>
                <div className="flex gap-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <p className="font-normal text-xs">3.386 Siswa terdaftar</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <span className="flex text-center  md:mt-0 mt-10 flex-col gap-4">
            ...
            <div className="flex justify-center">
              <p className="font-medium md:w-[70%]">
                Jadilah developer expert dengan belajar berbagai macam skill
                yang diperlukan di dunia industri, termasuk performa dan
                keamanan aplikasi.
              </p>
            </div>
          </span>
      ...
      <div className="mt-32  flex flex-col justify-center gap-10 items-center">
        ...
        <div className="flex hover:gap-3 transition duration-300">
          <span className="border-[3px] border-dark rounded-full relative z-10 m-mauto inline-block  hover:m-auto  transition ease-out duration-200">
            <img
              src="https://d17ivq9b7rppb3.cloudfront.net/small/avatar/2019081409575475c319da92001d054ba55e25bf2341cf.jpeg"
              alt=""
          ...
          <span className="border-[3px] border-dark rounded-full relative z-10 m-mauto  hover:m-auto inline-block transition ease-out duration-200">
            <img
              src="https://d17ivq9b7rppb3.cloudfront.net/small/avatar/2019021822335607efd583780d15ddfcba1666bdbad7bb.jpg"
              alt=""
              className="w-[42px] h-[42px] rounded-full"
            />
          </span>
          <span className="border-[3px] border-dark rounded-full relative z-10 m-mauto  hover:m-auto inline-block transition ease-out duration-200">
            <img
              src="https://d17ivq9b7rppb3.cloudfront.net/small/avatar/20210902191717dd006ff1d467e81c1f0b7cdf569e97bd.png"
              alt=""
              className="w-[42px] h-[42px] rounded-full"
            />
          </span>
          <span className="border-[3px] border-dark rounded-full relative z-10 m-mauto hover:border-dark hover:m-auto inline-block transition ease-out duration-200">
            <img
              src="https://dicoding-web-img.sgp1.cdn.digitaloceanspaces.com/small/avatar/dos:b183f710e8031d20a60544caf40a319b20221216195155.png"
              alt=""
              className="w-[42px] h-[42px] rounded-full"
            />
          </span>
          ...
          <div className="flex gap-10 flex-wrap justify-center items-center">
            <div className="border md:w-[500px] rounded-md w-full h-[300px] border-gray-500">
              <div className="flex top-0 left-0 ml-3 mt-4 mb-3">
                <img
                  src="https://d17ivq9b7rppb3.cloudfront.net/small/avatar/20191022105311fae87a3c2f2a310067a8ad8091fba097.jpg"
                  className="rounded-full w-10 h-10 border-2 border-dark p-[1px] d"
                />
                <div className="ml-3">
              ...
              <div className="text-gray-700 mx-3 font-medium">
                Kelas ini memberikan insight dan cara pandang baru dari seorang
                developer expert ketika mengembangkan sebuah aplikasi berbasis
                Android.
              </div>
            </div>
            <div className="border md:w-[500px] rounded-md w-full h-auto sm:h-[300px]  pb-4 border-gray-500">
              <div className="flex top-0 left-0 ml-3 mt-4 mb-3">
                <img
                  src="https://d17ivq9b7rppb3.cloudfront.net/small/avatar/202009040521330eea1266dd6d70769248cff6bca696a4.png"
                  className="w-10 h-10 rounded-full p-[1px] border-2 border-dark d"
                />
                <div className="ml-3">
                  <div className="text-sm text-gray-700">
              ...
              <div className="text-gray-700 mx-3 font-medium">
                Meningkatnya perkembangan Android yang sangat pesat membuat saya
                sadar untuk mengupgrade skill. Belajar pengembangan Android
                hingga tingkat expert merupakan perjalanan yang tidak mudah.
              </div>
            </div>
          </div>
        </div>
