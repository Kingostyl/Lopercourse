    ...
    <Navbar/>
      <main className=" text-dark py-28 bg-cover w-full">
        ...
        <div className="flex flex-col gap-4 justify-center items-center">
          ...
          <p className="text-center font-medium text-sm md:text-xl px-5 md:w-[50%]">
            Kurikulum disusun oleh Lopercourse bersama Google Kurikulum disusun
            oleh lopercourse bersama AWS beserta pelaku industri Back-End
            Development. Siswa dipersiapkan untuk menjadi Back-End Developer
      ...
      <main className="mt-32 px-3 md:px-20 w-full ">
        <div className="flex-col md:flex  justify-between w-full items-center ">
          <div className=" px-6 md:w-[370px] sm:h-[164px] flex items-center hover:shadow-lg mx-auto h-auto py-2 border rounded-md border-gray-600  bg-white text-dark">
            <div className="gap-2 md:gap-3 flex flex-col">
              ...
              <div className="flex gap-9">
                <div className="flex gap-3">
                  ...
                  <p className="font-semibold text-xs">18 jam</p>
                </div>
                <div className="flex gap-3">
                  <svg
                    width={16}
              ...
              <div className="flex gap-4">
                ...
                <div className="flex gap-3">
                  ...
                  <p className="font-normal text-xs">151.332 Siswa terdaftar</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <span className="flex text-center  md:mt-0 mt-10 flex-col gap-4">
            ...
            <div className="flex justify-center">
              <p className="font-medium text-center md:w-[60%]">
                Belajar dasar-dasar AWS Cloud, mulai dari konsep cloud hingga
                cara membangun arsitektur yang baik.
              </p>
            </div>
          </span>
        </div>
        <div className="flex-col md:flex mt-8 justify-between w-full items-center">
          <div className=" px-6 md:w-[370px] sm:h-[164px] flex items-center hover:shadow-lg mx-auto py-2 h-auto border rounded-md border-gray-600 bg-white text-dark">
            <div className="gap-2 md:gap-3 flex flex-col">
              <div className="flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <span className="flex text-center md:mt-0 mt-10 flex-col gap-4">
            ...
            <div className="flex justify-center">
              <p className="font-medium md:w-[50%]">
                ...
                fundamental, sintaks dan fitur ES6, hingga konsep automation
                test menggunakan framework ternama.
              </p>
            </div>
          </span>
        </div>
        <div className="flex-col md:flex mt-8 justify-between w-full items-center">
          <div className=" px-6 md:w-[370px] py-2 h-auto sm:h-[164px] flex items-center hover:shadow-lg mx-auto  border rounded-md border-gray-600 bg-white text-dark">
            <div className="gap-2 md:gap-4 flex flex-col">
              ...
              <div className="flex gap-9">
                ...
                <div className="flex gap-3">
                  ...
                  <p className="font-semibold text-xs">4,90</p>
                </div>
                <div className="flex gap-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="flex gap-4">
                <div className="flex gap-3">
                  ...
                  <p className="font-normal text-xs">40,modul</p>
                </div>
                <div className="flex gap-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <p className="font-normal text-xs">51.322 Siswa terdaftar</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <span className="flex text-center  md:mt-0 mt-10 flex-col gap-4">
            ...
            <div className="flex justify-center">
              <p className="font-medium md:w-[70%]">
                Pahami dasar-dasar dalam membangun RESTful API, mulai dari HTTP
                server, routing, hingga membangun Back-End untuk aplikasi yang
                nyata.
              </p>
            </div>
          </span>
        ...
        <div className="flex-col md:flex mt-8 justify-between w-full items-center">
            ...
            <div className="gap-3 flex flex-col">
              ...
              <div className="flex gap-9">
                ...
                <div className="flex gap-3">
                  ...
                  <p className="font-semibold text-xs">4,70</p>
                </div>
                <div className="flex gap-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="flex gap-4">
                <div className="flex gap-3">
                  ...
                  <p className="font-normal text-xs">130,modul</p>
                </div>
                <div className="flex gap-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <p className="font-normal text-xs">49.395 Siswa terdaftar</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <span className="flex text-center md:mt-0 mt-10 flex-col gap-4">
            <h1 className="font-bold text-xl">Membangun Arsitektur Cloud</h1>
            <div className="flex justify-center">
              <p className="font-medium md:w-[70%]">
                Bangun arsitektur cloud pertamamu di AWS, mulai dari yang
                sederhana dengan Amazon S3 hingga yang canggih dengan
                serverless.
              </p>
            </div>
          </span>
        ...
        <div className="flex-col md:flex mt-8 justify-between w-full items-center">
            ...
            <div className="gap-2 md:gap-4 flex flex-col">
              ...
              <div className="flex gap-9">
                ...
                <div className="flex gap-3">
                  ...
                  <p className="font-semibold text-xs">4,91</p>
                </div>
                <div className="flex gap-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="flex gap-4">
                <div className="flex gap-3">
                  ...
                  <p className="font-normal text-xs">182,modul</p>
                </div>
                <div className="flex gap-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <p className="font-normal text-xs">4.202 Siswa terdaftar</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <span className="flex text-center  md:mt-0 mt-10 flex-col gap-4 ">
            <h1 className="font-bold text-xl">Memperkuat Fundamental</h1>
            <div className="flex justify-center">
              <p className="font-medium md:w-[70%]">
                Dalami teknologi dalam membangun RESTful API yang canggih,
                seperti Database, Storage, hingga Authentication dan
                Authorization.
              </p>
            </div>
          </span>
        ...
        <div className="flex-col md:flex mt-8  w-full items-center">
            ...
            <div className="gap-4 flex flex-col">
              ...
              <div className="flex gap-9">
                <div className="flex gap-3">
                  ...
                  <p className="font-semibold text-xs">76 jam</p>
                </div>
                <div className="flex gap-3">
                  <svg
                    width={16}
                  ...
                  <p className="font-semibold text-xs">4,92</p>
                </div>
                <div className="flex gap-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="flex gap-4">
                <div className="flex gap-3">
                  ...
                  <p className="font-normal text-xs">99,modul</p>
                </div>
                <div className="flex gap-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <p className="font-normal text-xs">1.193 Siswa terdaftar</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <span className="flex text-center  md:mt-0 mt-10 flex-col gap-4">
            ...
            <div className="flex justify-center">
              <p className="font-medium md:w-[70%]">
                Mahir di bidang Back-End dengan mempelajari teknik Automation
                Testing, Clean Architecture, CI/CD, Security, dan Scalability
                dalam membangun RESTful API berskala industri.
              </p>
            </div>
          </span>
        </div>
      ...
      <div className="mt-32  flex flex-col justify-center gap-10 items-center">
        <span className="text-center font-bold text-3xl flex justify-center items-center">
          Jadilah bagian dari Back-End Developer
        </span>
          ...
          <div className="flex gap-10 flex-wrap justify-center items-center">
            <div className="border md:w-[500px] rounded-md w-full h-[300px] border-gray-500 ">
              <div className="flex top-0 left-0 ml-3 mt-4 mb-3">
                <img
                  src="https://dicoding-web-img.sgp1.cdn.digitaloceanspaces.com/small/avatar/dos:93d0ade44033fd0455ca24a4afecaf9a20220623142528.png"
              ...
              <div className="text-gray-700  mx-3 font-medium">
                Saya sangat menyukai kelas ini. Saya dapat belajar lebih terarah
                untuk arsitektur aws dibandingkan belajar sendiri.
              </div>
            </div>
            <div className="border md:w-[500px] rounded-md w-full h-auto pb-4 sm:h-[300px]  border-gray-500 ">
              <div className="flex top-0 left-0 ml-3 mt-4 mb-3">
                <img
                  src="https://d17ivq9b7rppb3.cloudfront.net/small/avatar/20210422234531944c514a72670f5984c36af3698e6ea2.png"
              ...
              <div className="text-gray-700 mx-3 font-medium ">
                Kelas yang sangat lengkap dari sisi teori maupun praktek.
                Modul-modul yang menjelaskan bagaimana cara deploy program kita
                ke AWS, benar-benar mempersiapkan kita untuk penerapan AWS
              </div>
            </div>
          </div>
        </div>
